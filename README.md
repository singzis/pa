...
uv run python main.py "https://example.com/gallery" --manual-login --auth-state .auth/jd.json
uv run python main.py "https://example.com/gallery" --auth-state .auth/jd.json
```
